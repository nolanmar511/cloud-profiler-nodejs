...
function serialize<T extends ProfileNode>(
  ...
  function getLocation(
      node: ProfileNode, parentFunction?: string): perftools.profiles.Location {
  ...
  function getFunction(
      node: ProfileNode, name: string): perftools.profiles.Function {
...
export function serializeTimeProfile(
    ...
    hasLines?: boolean): perftools.profiles.IProfile {
